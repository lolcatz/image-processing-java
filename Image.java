...
public class Image {
  ...
  public static Image Smoothen_(Image helper, Image im, int row_start, int row_end) {
  ...
  public static Image Sharpen_(Image helper, Image im, int row_start, int row_end) {
    int r_sum = 0, b_sum = 0, g_sum = 0, index;
